...
- 上传资产 ID: 9fa5d58b-ac8a-4d10-9bca-57e50a7ba4d1
- 上传后到 ready: 131727ms
- 关键断言:
...
- 关键接口耗时:
  - POST /api/content-assets/upload: 7.25s (200)
  ...
  - POST /api/content-assets/status: 0.44s (200)
  - POST /api/content-assets/status: 0.40s (200)
  - POST /api/content-assets/status: 1.15s (200)
  - POST /api/content-assets/status: 0.39s (200)
  - POST /api/content-assets/status: 0.40s (200)
  - POST /api/content-assets/status: 0.41s (200)
  - POST /api/content-assets/status: 0.38s (200)
  - POST /api/content-assets/status: 0.40s (200)
  - POST /api/content-assets/status: 0.45s (200)
  - POST /api/content-assets/status: 0.52s (200)
  - POST /api/content-assets/status: 0.43s (200)
  - POST /api/content-assets/status: 0.39s (200)
  - POST /api/content-assets/status: 0.38s (200)
  - POST /api/content-assets/status: 0.39s (200)
  ...
  - POST /api/content-assets/status: 0.38s (200)
  - POST /api/content-assets/status: 0.47s (200)
  - POST /api/agent/preflight: 2.31s (200)
  - POST /api/agent/chat: 6.88s (200)
  - POST /api/agent/preflight: 1.60s (200)
  - POST /api/agent/chat: 7.61s (200)
- 错误统计:
  - 静态资源 404: 0
  - console error: 0
  - pageerror: 0
...
- 产物目录:
  - output/playwright/agent-context-sidebar-material-upload-guard-rerun-20260326-201747
