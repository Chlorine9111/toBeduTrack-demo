...
import { unpublishLessonPlan } from "@/lib/lesson-plan/store";
...
export async function POST(
  ...
  try {
    await unpublishLessonPlan(contextResult.value, parsedParams.data.planId);
    ...
    return jsonError("INTERNAL_ERROR", "取消发布失败", 500);
  }
}
